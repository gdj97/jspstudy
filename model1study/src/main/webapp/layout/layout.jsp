<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--/src/main/webapp/layout/layout.jsp
   <sitemesh:write property="title" />  : title 태그의 내용
   <sitemesh:write property="head" />   : head 태그의 내용. title의 내용은 제외함 
   <sitemesh:write property='body'/>    : body 태그의 내용   
--%>
...
<tr><td colspan="3">구디아카데미</td></tr></table>
</body></html>