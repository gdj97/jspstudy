<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- /src/main/webapp/member/main.jsp
...
<body>
<% 
   String login = (String)session.getAttribute("login"); //아이디 저장.
   if (login != null) {  //로그인 데이터 존재
 %>
	<h3><%=login %>님이 로그인 하셨습니다.</h3>
	...
	<% } %>
<% }  else { //로그 아웃상태. session 에 login 속성값이 없는 경우 %>
