...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- /src/main/webapp/view/member/info.jsp
   1. 로그인 상태 검증 
...
<%--
!id.equals(login) : 파라미터로 입력된 아이디 != 로그인된아이드  
 --%>
<% } else if(!id.equals(login) && !login.equals("admin")) { //로그인 상태. %>
...
<%
   Member mem = new MemberDao().selectOne(id); //id 값에 해당하는 회원 정보를 DB에서 조회하여 Memeber 객체로 리턴
%>
<!DOCTYPE html>
<html>
<head>
