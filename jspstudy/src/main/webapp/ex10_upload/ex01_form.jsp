<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- /src/main/webapp/ex10_upload/ex01_form.jsp --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div>
 <%--
   ...
   ex01_upload.jsp 페이지에는 파라미터값+파일정보(이름,내용) 전달됨. => request 객체 사용 불가. 다른 유틸리티가 필요함.(cos.jar)
    
  --%>
 <form id="frm_upload" action="ex01_upload.jsp" method="post" enctype="multipart/form-data">
    ...
    <div><button>첨부하기</button><input type="reset" value="다시작성"></div>
</form>
</div>
</body>
</html>