...
<%--
   ...
   3) taglib : 커스텀태그 사용시 설정. JSTL사용시 설명
 --%>
<% //스크립트릿 : 자바의 영역. 
 	Date today = new Date();
...
<h3>page Directive의 속성</h3>
<ul>
	<li>contentType : 반드시 구현해야함. 필수 속성. 현재페이지의 종류 MIME타입(text/html)으로 설정함.</li>
	<li>import : 패키지명을 생략 할수 있도록 설정. 여러번 설정이 가능함.</li>
	<li>pageEncoding : 인코딩 방식 설정. 생략 가능함. contentType의 charset과 동일함.</li>
	<li>isErrorPage="true|false" : 기본값이 false임. <br>
	  true인경우 현재 페이지가 오류 페이지로 설정함. </li>
</ul>
</body>
</html>